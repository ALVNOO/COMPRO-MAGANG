...
@section('title', 'Absensi Peserta - Mentor')

@section('content')
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2 class="h4 mb-1">Daily Attendance</h2>
            <p class="text-muted mb-0">Pantau absensi peserta magang</p>
        </div>
    </div>
    ...
    <div class="card mb-4">
        <div class="card-body">
            <form method="GET" action="{{ route('mentor.absensi') }}" class="row g-3 align-items-end">
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    ...
                    <a href="{{ route('mentor.absensi') }}" class="btn btn-secondary">
