            ...
            <div class="card-body" style="padding: 1.5rem;">
                <div class="row align-items-end">
                    <div class="col-md-4">
                        ...
                        <input type="date" id="filterDate" class="form-control" value="{{ $selectedDate ?? today()->toDateString() }}" max="{{ today()->toDateString() }}" style="border-radius: 12px; border: 2px solid #EE2E24;">
                    </div>
                    <div class="col-md-2">
                        <button onclick="filterByDate()" class="btn w-100" style="background: linear-gradient(135deg, #EE2E24 0%, #F60000 100%); color: white; border-radius: 12px; font-weight: 600; padding: 0.75rem;">
